...
document.getElementById("btn").addEventListener("click", () => {
    ...
    loadFile((data) => {
        ...
        if (!userMessage || typeof userMessage.trim !== 'function') {
            ...
            return; // یا هر کدی که می‌خواهید اجرا کنید
        }
        ...
        if (response === "teamA") {
            window.location.href = "./team/A.html";
        } else if (response === "teamB") {
            window.location.href = "./team/B.html";
        } else if (response === "teamC") {
            window.location.href = "./team/C.html";
        }
    });
});
